...
1) Implementiere die beiden Funktionen
...
verschlüsselt werden, zum Beispiel Steuerzeichen wie newline. 
...
die bei der Verschlüsselung von gregor_samsa.txt verwendet wurde, schließen? 
Führe dazu auch eine Frequenzanalyse des verschlüsselten gregor_samsa-Textes 
aus.
