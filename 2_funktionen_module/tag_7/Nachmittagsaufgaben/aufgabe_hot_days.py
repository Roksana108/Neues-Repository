"""
Schreibe eine Funktion get_hot_work_days(), die aus der Liste weekday_temperatures  eine neue Liste hot_work_days erstellt.
In diese neue Liste sollen nur Tage kommen, die nicht am Wochenende sind und Temperaturen größer gleich 30 Grad Celcius hatten.
...
Hinweise: diese Aufgabe optional mit list comprehension lösen.
Nutze Typehints!
"""
